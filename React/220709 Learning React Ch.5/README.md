- [Learning React](#learning-react)
  - [Ch.5 JSX를 사용하는 리액트](#ch5-jsx를-사용하는-리액트)
    - [1. JSX로 리액트 엘리먼트 정의하기](#1-jsx로-리액트-엘리먼트-정의하기)
      - [1.1 JSX 팁](#11-jsx-팁)
        - [내포된 컴포넌트](#내포된-컴포넌트)
        - [className](#classname)
        - [자바스크립트 식](#자바스크립트-식)
        - [평가](#평가)
      - [1.2 배열을 JSX로 매핑하기](#12-배열을-jsx로-매핑하기)
    - [2. 바벨](#2-바벨)
    - [3. JSX로 작성한 조리법](#3-jsx로-작성한-조리법)
    - [4. 리액트 프래그먼트](#4-리액트-프래그먼트)
    - [5. 웹팩 소개](#5-웹팩-소개)
      - [5.1 프로젝트 설정하기](#51-프로젝트-설정하기)
        - [1.프로젝트 생성하기](#1프로젝트-생성하기)
        - [2. 컴포넌트를 모듈로 나누기](#2-컴포넌트를-모듈로-나누기)
        - [3. 웹팩 빌드 만들기](#3-웹팩-빌드-만들기)
      - [5.2 번들 로딩하기](#52-번들-로딩하기)
      - [5.3 소스 맵](#53-소스-맵)
      - [5.4 create-react-app](#54-create-react-app)
# Learning React
## Ch.5 JSX를 사용하는 리액트
